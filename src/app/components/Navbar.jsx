  ...
  return (
    <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center"> 
        <Link href="/" className="text-sm bg-black p-1 font-semibold rounded-md flex items-center justify-center">
            <span className="text-white mr-1">Fron</span>
      ...
      <div className="md:hidden">
        ...
        {/* Menu List */}
        {open && ( 
        <motion.div variants={listVariants} initial="closed" animate="opened" className="top-0 left-0 absolute w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-4xl z-40">
            {links.map(links=>(
              <motion.div variants={listItemVariants} className="" key={links.title}>
